...
class Screen(Static):
    ...
    def advance(self):
        self.frame_i += 1
        self.walk_x += self.walk_dir          # step
        if abs(self.walk_x) >= 5:             # turn around at the edge
