...
class TuiPetApp(App):
    ...
    WHATS_NEW = ("Your pet listens now! Walking, feeding and training no "
                 "longer refuse every few seconds — a decently-raised pet "
                 "obeys, while a neglected one still acts up. No more scolding "
                 "it just to take one step.")
