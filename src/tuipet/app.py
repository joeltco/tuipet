...
class TuiPetApp(ActionsMixin, App):
    ...
    WHATS_NEW = ("THE DODGE IS A REAL REFLEX NOW: road ambushes used to "
                 "accept SPACE anywhere in the whole 1.6-second beat — and "
                 "since SPACE also hurries the march, your mash won dodges "
                 "by accident before the ! even registered. New grammar, "
                 "one press per ambush: '! ! ! wait for it…' during the "
                 "warning (jump early and the duck is SPENT), then 'NOW! — "
                 "SPACE' as it lunges. Duck the window, eat the pounce, or "
