...
in the selected habitat; the picker line rides the #msg strip; ownership
details live on the status card.  (The thermostat and the climate report
left with the weather system; BASIC VPET 2026-07-16.)"""
...
class HabitatPanel:
    def __init__(self, pet):
        ...
        self.frame_i = 0
        self.msg = "Browse homes — ENTER moves in."
