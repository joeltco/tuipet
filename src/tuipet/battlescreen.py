...
def mega_window(pet):
    ...
    hu = pet.hunger / pet.hunger_max if pet.hunger_max else 0
    st = pet.strength / pet.strength_max if pet.strength_max else 0
    en = pet.energy / pet.max_energy if pet.max_energy else 0
    ag = min(pet.age_days / 5, 1)
