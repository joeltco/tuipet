"""Pin the effect-sprite set + key shapes so a future art regen can't silently drop
or malform them. All effects/orbs/overlays/the food icon are now generated by
tools/gen_art.py (original 1-bit art, NOT ripped from DVPet); this guards the
curated glyphs (poop, the st_* status column, dying) and the battle overlays."""
