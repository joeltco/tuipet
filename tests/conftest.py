...
@pytest.fixture
def live_pet():
    """A freshly-spawned Child from real sprite data (skips if assets missing)."""
...
def _sandbox_lobby_feed(tmp_path, monkeypatch):
    ...
    if srv is not None and hasattr(srv, "RAID_PATH"):
        monkeypatch.setattr(srv, "RAID_PATH", str(tmp_path / "raid.json"))
        monkeypatch.setattr(srv, "RAID", {"boss": None, "board": {},
                                          "history": [], "claimed": {},
                                          "attempts": {}})
